...
|---|---|---|---|---|
| なし（初回） | Phase 1-2: 要件定義 | `phase-requirements-agent` | claude-opus-4-7 | `~/.claude/skills/dev-flow-requirements/SKILL.md` |
| phase_2 | Phase 3-4: ドキュメント生成 | `phase-spec-agent` | claude-haiku-4-5-20251001 | `~/.claude/skills/dev-flow-spec/SKILL.md` |
| phase_4 | Phase 4.5: 整合性チェック | `phase-consistency-agent` | claude-haiku-4-5-20251001 | `~/.claude/skills/dev-flow-consistency/SKILL.md` |
| phase_4_5 | Phase 5: 並列実装 | `phase-impl-agent` | claude-haiku-4-5-20251001 | `~/.claude/skills/dev-flow-implementation/SKILL.md` |
| phase_5 | Phase 6: テスト実行 | `phase-test-agent` | claude-haiku-4-5-20251001 | `~/.claude/skills/dev-flow-test/SKILL.md` |
| phase_6 | Phase 7-8: 準拠チェック・完了 | `phase-compliance-agent` | claude-opus-4-7 | `~/.claude/skills/dev-flow-compliance/SKILL.md` |
...
/dev-flow (初回)
  ...
  ↓ Agent(name="phase-requirements-agent", model="claude-opus-4-7")
Phase 1-2: 要件定義
...
/dev-flow
  ...
  ↓ Agent(name="phase-spec-agent", model="claude-haiku-4-5-20251001")
Phase 3-4: ドキュメント生成
...
/dev-flow
  ...
  ↓ Agent(name="phase-consistency-agent", model="claude-haiku-4-5-20251001")
...
/dev-flow
  ...
  ↓ Agent(name="phase-impl-agent", model="claude-haiku-4-5-20251001")
...
/dev-flow
  ...
  ↓ Agent(name="phase-test-agent", model="claude-haiku-4-5-20251001")
Phase 6: テスト実行
...
/dev-flow
  ...
  ↓ Agent(name="phase-compliance-agent", model="claude-opus-4-7")
Phase 7-8: 準拠チェック・完了
